...
import { BunHttpServer, BunRuntime, BunFileSystem, BunHttpPlatform } from "@effect/platform-bun";
...
const ServerLive = HttpApiBuilder.serve().pipe(
  ...
  Layer.provide(
    Layer.unwrapEffect(
      Effect.andThen(Config.string("PORT"), (port) => BunHttpServer.layerServer({ port })),
    ),
  ),
